...
logger = logging_client.logger('load-balancer-hw8')
    ...
    if flask.request.method == 'GET':
        ...
        try:
            ...
            if not blob:
                ...
                # Add the zone information to the response header
                response = flask.Response(file_content, status=200)
